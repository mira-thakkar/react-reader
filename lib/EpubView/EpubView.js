...
global.ePub = _epubjs2.default; // Fix for v3 branch of epub.js -> needs ePub to by a global var

var EpubView = function (_PureComponent) {
  _inherits(EpubView, _PureComponent);
  ...
  _createClass(EpubView, [{
    ...
    value: function componentDidMount() {
      ...
      var epubOptions = this.props.epubOptions;
      this.book = new _epubjs2.default(url, epubOptions);
